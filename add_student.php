...
<div class="col-md-8" style="border:1px solid; border-radius:20px; height:280px; background:#dddddd">
...
<div class="col-md-6">
    <input type="email" name="date" placeholder="Date of Birth" class="form-control" required>
...
<select  name="parentID"  class="form-control">
        <option hidden>Parent Name</option>
        <option >Male</option>
        <option >Female</option>
</select>
</div>
...
<div class="row" style="margin-top:30px;">
<div class="col-md-6">
<center> <input type="submit" value="Add Student" class="btn btn-primary" required></center>
